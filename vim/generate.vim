"*****************************************************************************
" Kommentare in Vimscript starten mit '"'.
" erstellt mit:
" vim-bootstrap 2017-04-05 15:00:00
" erweitert von Jörg M.
"*****************************************************************************
...
Plug 'alvan/vim-closetag'  " ***ml close tags
Plug 'mg979/vim-visual-multi', {'branch': 'master'}
Plug 'mattn/emmet-vim'
Plug 'junegunn/vim-easy-align'
Plug 'justinmk/vim-sneak'
Plug 'tpope/vim-commentary' "comment stuff out
Plug 'tpope/vim-surround' "set brackets
...
" Farbschema
Plug 'frazrepo/vim-rainbow' "showing different levels of parentheses in different colors
Plug 'vim-scripts/CSApprox' "colorscheme approximation
...
Plug 'tpope/vim-fugitive' "GitHub plugin
...
Plug 'neoclide/coc.nvim', {'branch': 'release'} " Node.js
...
nnoremap <silent> <F3> :NERDTreeToggle<CR>:IndentLinesToggle<CR>
