...
function prompt {
    ...
    Write-Host " USER:$($CmdPromptUser.Name.split("\")[1]) " -BackgroundColor LightBlue -ForegroundColor White -NoNewline
...
$colors.ProgressForegroundColor = "Black"
$colors.ProgressBackgroundColor = "DarkCyan"
